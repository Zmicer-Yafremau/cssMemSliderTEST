/*const TEXT = ['First slide','Second slide','Third slide','Fourth slide'];*/
...
if(value.lastChild.classList.contains("active")){
    ...
    /*document.querySelector('span').innerHTML = TEXT[ +value.lastChild.className.match(/[012345]/)[0] ];*/
  ...
  value.lastChild.classList.toggle("active");
     value.lastChild.style.backgroundColor = ""
/*document.querySelector('span').innerHTML = TEXT[ +value.lastChild.className.match(/[012345]/)[0] ];*/
  document.querySelector('.memes').style.backgroundImage = IMAGE[ +value.lastChild.className.match(/[012345]/)[0] ];
